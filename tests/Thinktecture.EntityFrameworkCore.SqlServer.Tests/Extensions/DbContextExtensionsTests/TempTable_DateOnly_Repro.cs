...
/// Without the fix the TempTableConvention and the SqlServerCollectionParameterConvention configure
...
public class TempTable_DateOnly_Repro
{
   ...
   private sealed class MinimalDbContext : DbContext
   {
      ...
      protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
      {
         ...
         optionsBuilder.UseSqlServer("Server=(local);Database=Test;Trusted_Connection=True;",
      ...
      protected override void OnModelCreating(ModelBuilder modelBuilder)
      {
         ...
         // SqlServerCollectionParameterConvention and collapses each generic-argument pair onto the
         // same table name.
