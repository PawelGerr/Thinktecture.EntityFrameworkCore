...
namespace Thinktecture.EntityFrameworkCore.TempTables.SqlServerTempTableCreatorTests
{
   public class CreateTempTableAsync : IntegrationTestsBase
   {
      ...
      {
         _sut.Awaiting(async c => await c.CreateTempTableAsync<TempTable<int>>(DbContext).ConfigureAwait(false))
      ...
      public async Task Should_create_temp_table_with_one_column()
      {
         ...
         await _sut.CreateTempTableAsync<TempTable<int>>(DbContext).ConfigureAwait(false);
      ...
      public async Task Should_create_temp_table_with_double()
      {
         ...
         await _sut.CreateTempTableAsync<TempTable<double>>(DbContext).ConfigureAwait(false);
      ...
      public async Task Should_create_temp_table_with_decimal()
      {
         ...
         await _sut.CreateTempTableAsync<TempTable<decimal>>(DbContext).ConfigureAwait(false);
      ...
      public async Task Should_create_temp_table_with_bool()
      {
         ...
         await _sut.CreateTempTableAsync<TempTable<bool>>(DbContext).ConfigureAwait(false);
      ...
      public async Task Should_create_temp_table_with_string()
      {
         ...
         await _sut.CreateTempTableAsync<TempTable<string>>(DbContext).ConfigureAwait(false);
      ...
      public async Task Should_create_temp_table_with_2_columns()
      {
         ...
         await _sut.CreateTempTableAsync<TempTable<int, string>>(DbContext).ConfigureAwait(false);
