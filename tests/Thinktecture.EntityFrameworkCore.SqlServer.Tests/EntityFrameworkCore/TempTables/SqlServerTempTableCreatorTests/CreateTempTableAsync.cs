...
namespace Thinktecture.EntityFrameworkCore.TempTables.SqlServerTempTableCreatorTests
{
   ...
   public class CreateTempTableAsync : IntegrationTestsBase
   {
      ...
      {
         // ReSharper disable once RedundantArgumentDefaultValue
         await _sut.CreateTempTableAsync(DbContext, DbContext.GetEntityType<TestEntity>(), new TempTableCreationOptions()).ConfigureAwait(false);
      ...
      {
         _sut.Awaiting(async c => await c.CreateTempTableAsync(DbContext, DbContext.GetEntityType<TempTable<int>>(), new TempTableCreationOptions()).ConfigureAwait(false))
      ...
      public async Task Should_create_temp_table_with_one_column()
      {
         ...
         await _sut.CreateTempTableAsync(DbContext, DbContext.GetEntityType<TempTable<int>>(), new TempTableCreationOptions()).ConfigureAwait(false);
      ...
      public async Task Should_create_temp_table_with_double()
      {
         ...
         await _sut.CreateTempTableAsync(DbContext, DbContext.GetEntityType<TempTable<double>>(), new TempTableCreationOptions()).ConfigureAwait(false);
      ...
      public async Task Should_create_temp_table_with_decimal()
      {
         ...
         await _sut.CreateTempTableAsync(DbContext, DbContext.GetEntityType<TempTable<decimal>>(), new TempTableCreationOptions()).ConfigureAwait(false);
      ...
      public async Task Should_create_temp_table_with_bool()
      {
         ...
         await _sut.CreateTempTableAsync(DbContext, DbContext.GetEntityType<TempTable<bool>>(), new TempTableCreationOptions()).ConfigureAwait(false);
      ...
      public async Task Should_create_temp_table_with_string()
      {
         ...
         await _sut.CreateTempTableAsync(DbContext, DbContext.GetEntityType<TempTable<string>>(), new TempTableCreationOptions()).ConfigureAwait(false);
      ...
      public async Task Should_create_temp_table_with_2_columns()
      {
         ...
         await _sut.CreateTempTableAsync(DbContext, DbContext.GetEntityType<TempTable<int, string>>(), new TempTableCreationOptions()).ConfigureAwait(false);
