...
namespace Thinktecture.EntityFrameworkCore.TempTables.SqlServerTempTableCreatorTests
{
   ...
   public class CreatePrimaryKeyAsync : IntegrationTestsBase
   {
      ...
      public async Task Should_create_primary_key_for_keylessType()
      {
         ...
         var tempTableReference = await ArrangeDbContext.CreateTempTableAsync<TempTable<int>>(false, false);
      ...
      {
         var tempTableReference = await ArrangeDbContext.CreateTempTableAsync<TestEntity>(false, false);
      ...
      {
         var tempTableReference = await ArrangeDbContext.CreateTempTableAsync<TestEntity>(createPrimaryKey: false);
