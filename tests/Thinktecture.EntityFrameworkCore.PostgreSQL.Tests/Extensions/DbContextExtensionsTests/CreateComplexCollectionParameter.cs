...
{
   public CreateComplexCollectionParameter(ITestOutputHelper testOutputHelper, NpgsqlFixture npgsqlFixture)
   ...
   {
      ActDbContext.CreateComplexCollectionParameter([new MyParameter(new Guid("D3E99F44-40A1-4E4E-820F-9D7C7B02AFA5"), new ConvertibleClass(42))], applyDistinct)
                  .ToList()
                  .Should().BeEquivalentTo([new MyParameter(new Guid("D3E99F44-40A1-4E4E-820F-9D7C7B02AFA5"), new ConvertibleClass(42))]);
   }
   ...
   public async Task Should_work_with_joins(bool applyDistinct)
   {
      ...
      var collectionParameter = ActDbContext.CreateComplexCollectionParameter([new MyParameter(testEntity.Id, new ConvertibleClass(42))], applyDistinct);
