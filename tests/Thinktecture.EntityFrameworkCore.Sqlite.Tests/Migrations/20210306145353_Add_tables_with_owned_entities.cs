   ...
   public partial class Add_tables_with_owned_entities : Migration
   {
      protected override void Up(MigrationBuilder migrationBuilder)
      {
                                      ...
                                      table => new
                                               {
                                                  ...
                                                  InlineEntity_StringColumn = table.Column<string>("TEXT", nullable: true),
                                                  InlineEntity_IntColumn = table.Column<int>("INTEGER", nullable: false),
                                                  InlineEntity_InlineEntity_StringColumn = table.Column<string>("TEXT", nullable: true),
                                                  InlineEntity_InlineEntity_IntColumn = table.Column<int>("INTEGER", nullable: false)
                                               },
         ...
         migrationBuilder.CreateTable("InlineEntities_SeparateMany",
                                      table => new
                                               {
                                                  OwnedEntity_Owns_SeparateManyTestEntity_Owns_Inline_SeparateManyId = table.Column<Guid>("TEXT", nullable: false),
                                      ...
                                      constraints: table =>
                                                   {
                                                      ...
                                                      table.ForeignKey(
                                                                       "FK_InlineEntities_SeparateMany_TestEntities_Own_Inline_SeparateMany_OwnedEntity_Owns_SeparateManyTestEntity_Owns_Inline_SeparateManyId",
         ...
         migrationBuilder.CreateTable("InlineEntities_SeparateOne",
                                      table => new
                                               {
                                                  OwnedEntity_Owns_SeparateOneTestEntity_Owns_Inline_SeparateOneId = table.Column<Guid>("TEXT", nullable: false),
                                                  StringColumn = table.Column<string>("TEXT", nullable: true),
                                                  IntColumn = table.Column<int>("INTEGER", nullable: false)
                                               },
                                      constraints: table =>
                                                   {
                                                      ...
                                                      table.ForeignKey(
                                                                       "FK_InlineEntities_SeparateOne_TestEntities_Own_Inline_SeparateOne_OwnedEntity_Owns_SeparateOneTestEntity_Owns_Inline_SeparateOneId",
         ...
         migrationBuilder.CreateTable("SeparateEntitiesMany",
                                      table => new
                                               {
                                                  TestEntity_Owns_SeparateManyId = table.Column<Guid>("TEXT", nullable: false),
                                                  Id = table.Column<int>("INTEGER", nullable: false),
                                                  StringColumn = table.Column<string>("TEXT", nullable: true),
                                                  IntColumn = table.Column<int>("INTEGER", nullable: false)
                                               },
         ...
         migrationBuilder.CreateTable("SeparateEntitiesMany_Inline",
                                      table => new
                                               {
                                                  TestEntity_Owns_SeparateMany_InlineId = table.Column<Guid>("TEXT", nullable: false),
                                                  Id = table.Column<int>("INTEGER", nullable: false),
                                                  StringColumn = table.Column<string>("TEXT", nullable: true),
                                                  IntColumn = table.Column<int>("INTEGER", nullable: false),
                                                  InlineEntity_StringColumn = table.Column<string>("TEXT", nullable: true),
         ...
         migrationBuilder.CreateTable("SeparateEntitiesMany_SeparateEntitiesMany",
                                      table => new
                                               {
                                                  TestEntity_Owns_SeparateMany_SeparateManyId = table.Column<Guid>("TEXT", nullable: false),
                                                  Id = table.Column<int>("INTEGER", nullable: false),
                                                  StringColumn = table.Column<string>("TEXT", nullable: true),
                                                  IntColumn = table.Column<int>("INTEGER", nullable: false)
                                               },
                                      constraints: table =>
                                                   {
                                                      ...
                                                      table.ForeignKey(
                                                                       "FK_SeparateEntitiesMany_SeparateEntitiesMany_TestEntities_Own_SeparateMany_SeparateMany_TestEntity_Owns_SeparateMany_SeparateManyId",
         ...
         migrationBuilder.CreateTable("SeparateEntitiesMany_SeparateEntitiesOne",
                                      table => new
                                               {
                                                  TestEntity_Owns_SeparateMany_SeparateOneId = table.Column<Guid>("TEXT", nullable: false),
                                                  Id = table.Column<int>("INTEGER", nullable: false),
                                                  StringColumn = table.Column<string>("TEXT", nullable: true),
                                                  IntColumn = table.Column<int>("INTEGER", nullable: false)
                                               },
         ...
         migrationBuilder.CreateTable("SeparateEntitiesOne",
                                      table => new
                                               {
                                                  TestEntity_Owns_SeparateOneId = table.Column<Guid>("TEXT", nullable: false),
                                                  StringColumn = table.Column<string>("TEXT", nullable: true),
                                                  IntColumn = table.Column<int>("INTEGER", nullable: false)
                                               },
                                      constraints: table =>
         ...
         migrationBuilder.CreateTable("SeparateEntitiesOne_Inline",
                                      table => new
                                               {
                                                  TestEntity_Owns_SeparateOne_InlineId = table.Column<Guid>("TEXT", nullable: false),
                                                  StringColumn = table.Column<string>("TEXT", nullable: true),
                                                  IntColumn = table.Column<int>("INTEGER", nullable: false),
                                                  InlineEntity_StringColumn = table.Column<string>("TEXT", nullable: true),
                                                  InlineEntity_IntColumn = table.Column<int>("INTEGER", nullable: false)
         ...
         migrationBuilder.CreateTable("SeparateEntitiesOne_SeparateMany",
                                      table => new
                                               {
                                                  TestEntity_Owns_SeparateOne_SeparateManyId = table.Column<Guid>("TEXT", nullable: false),
                                                  StringColumn = table.Column<string>("TEXT", nullable: true),
                                                  IntColumn = table.Column<int>("INTEGER", nullable: false)
                                               },
                                      constraints: table =>
         ...
         migrationBuilder.CreateTable("SeparateEntitiesOne_SeparateOne",
                                      table => new
                                               {
                                                  TestEntity_Owns_SeparateOne_SeparateOneId = table.Column<Guid>("TEXT", nullable: false),
                                                  StringColumn = table.Column<string>("TEXT", nullable: true),
                                                  IntColumn = table.Column<int>("INTEGER", nullable: false)
                                               },
                                      constraints: table =>
         ...
         migrationBuilder.CreateTable("SeparateEntitiesMany_SeparateEntitiesMany_Inner",
                                      table => new
                                               {
                                                  OwnedEntity_Owns_SeparateManyTestEntity_Owns_SeparateMany_SeparateManyId = table.Column<Guid>("TEXT", nullable: false),
                                                  OwnedEntity_Owns_SeparateManyId = table.Column<int>("INTEGER", nullable: false),
                                                  Id = table.Column<int>("INTEGER", nullable: false),
                                                  StringColumn = table.Column<string>("TEXT", nullable: true),
                                                  IntColumn = table.Column<int>("INTEGER", nullable: false)
                                               },
                                      constraints: table =>
                                                   {
                                                      ...
                                                      table.ForeignKey(
                                                                       "FK_SeparateEntitiesMany_SeparateEntitiesMany_Inner_SeparateEntitiesMany_SeparateEntitiesMany_OwnedEntity_Owns_SeparateManyTestEntity_Owns_SeparateMany_SeparateManyId_OwnedEntity_Owns_SeparateManyId",
         ...
         migrationBuilder.CreateTable("SeparateEntitiesMany_SeparateEntitiesOne_Inner",
                                      table => new
                                               {
                                                  OwnedEntity_Owns_SeparateOneTestEntity_Owns_SeparateMany_SeparateOneId = table.Column<Guid>("TEXT", nullable: false),
                                                  OwnedEntity_Owns_SeparateOneId = table.Column<int>("INTEGER", nullable: false),
                                                  StringColumn = table.Column<string>("TEXT", nullable: true),
                                                  IntColumn = table.Column<int>("INTEGER", nullable: false)
                                               },
                                      constraints: table =>
                                                   {
                                                      ...
                                                      table.ForeignKey(
                                                                       "FK_SeparateEntitiesMany_SeparateEntitiesOne_Inner_SeparateEntitiesMany_SeparateEntitiesOne_OwnedEntity_Owns_SeparateOneTestEntity_Owns_SeparateMany_SeparateOneId_OwnedEntity_Owns_SeparateOneId",
         ...
         migrationBuilder.CreateTable("SeparateEntitiesOne_SeparateMany_Inner",
                                      table => new
                                               {
                                                  OwnedEntity_Owns_SeparateManyTestEntity_Owns_SeparateOne_SeparateManyId = table.Column<Guid>("TEXT", nullable: false),
                                                  Id = table.Column<int>("INTEGER", nullable: false),
                                                  StringColumn = table.Column<string>("TEXT", nullable: true),
                                                  IntColumn = table.Column<int>("INTEGER", nullable: false)
                                               },
                                      constraints: table =>
                                                   {
                                                      ...
                                                      table.ForeignKey(
                                                                       "FK_SeparateEntitiesOne_SeparateMany_Inner_SeparateEntitiesOne_SeparateMany_OwnedEntity_Owns_SeparateManyTestEntity_Owns_SeparateOne_SeparateManyId",
         ...
         migrationBuilder.CreateTable("SeparateEntitiesOne_SeparateOne_Inner",
                                      table => new
                                               {
                                                  OwnedEntity_Owns_SeparateOneTestEntity_Owns_SeparateOne_SeparateOneId = table.Column<Guid>("TEXT", nullable: false),
                                                  StringColumn = table.Column<string>("TEXT", nullable: true),
                                                  IntColumn = table.Column<int>("INTEGER", nullable: false)
                                               },
                                      constraints: table =>
                                                   {
                                                      ...
                                                      table.ForeignKey(
                                                                       "FK_SeparateEntitiesOne_SeparateOne_Inner_SeparateEntitiesOne_SeparateOne_OwnedEntity_Owns_SeparateOneTestEntity_Owns_SeparateOne_SeparateOneId",
