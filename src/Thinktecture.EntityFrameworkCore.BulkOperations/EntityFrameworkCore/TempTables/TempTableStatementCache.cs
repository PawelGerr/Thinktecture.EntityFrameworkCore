...
{
   private readonly ConcurrentDictionary<TCacheKey, ICachedTempTableStatement> _cache = new();
   ...
   public ICachedTempTableStatement GetOrAdd(TCacheKey cacheKey, Func<TCacheKey, ICachedTempTableStatement> factory)
   {
