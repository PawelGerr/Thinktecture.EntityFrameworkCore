...
/// <summary>
/// PostgreSQL-specific extension methods for <see cref="DbSet{TEntity}"/>.
/// </summary>
public static class NpgsqlBulkOperationsDbSetExtensions
{
   /// <summary>
      ...
      where TSource : class
   {
      ...
      var executor = target.GetService<NpgsqlBulkOperationExecutor>();
