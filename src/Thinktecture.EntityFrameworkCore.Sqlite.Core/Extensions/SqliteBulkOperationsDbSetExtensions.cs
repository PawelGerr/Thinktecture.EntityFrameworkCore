...
/// <summary>
/// Extension methods for <see cref="DbSet{TEntity}"/> to support query-based bulk update on SQLite.
/// </summary>
public static class SqliteBulkOperationsDbSetExtensions
{
   /// <summary>
      ...
      where TSource : class
   {
      ...
      var executor = target.GetService<SqliteBulkOperationExecutor>();
