...
public static class SqlServerDbFunctionsExtensions
{
   ...
   /// <param name="orderBy">Column(s) to order by.</param>
   /// <exception cref="InvalidOperationException">Is thrown if executed in-memory.</exception>
   public static long NTile(this DbFunctions _, int bucketCount, WindowFunctionOrderByClause orderBy)
   {
      throw new InvalidOperationException("This method is for use with Entity Framework Core only and has no in-memory implementation.");
   }
   ...
   /// </summary>
   /// <exception cref="InvalidOperationException">Is thrown if executed in-memory.</exception>
   public static long NTile<TColumn1>(this DbFunctions _, int bucketCount, TColumn1 partitionByColumn1, WindowFunctionOrderByClause orderBy)
   {
      throw new InvalidOperationException("This method is for use with Entity Framework Core only and has no in-memory implementation.");
   }
   ...
   /// </summary>
   /// <exception cref="InvalidOperationException">Is thrown if executed in-memory.</exception>
   public static long NTile<TColumn1, TColumn2>(this DbFunctions _, int bucketCount, TColumn1 partitionByColumn1, TColumn2 partitionByColumn2, WindowFunctionOrderByClause orderBy)
   {
      throw new InvalidOperationException("This method is for use with Entity Framework Core only and has no in-memory implementation.");
   }
   ...
   /// </summary>
   /// <exception cref="InvalidOperationException">Is thrown if executed in-memory.</exception>
   public static long NTile<TColumn1, TColumn2, TColumn3>(this DbFunctions _, int bucketCount, TColumn1 partitionByColumn1, TColumn2 partitionByColumn2, TColumn3 partitionByColumn3, WindowFunctionOrderByClause orderBy)
   {
      throw new InvalidOperationException("This method is for use with Entity Framework Core only and has no in-memory implementation.");
   }
   ...
   /// </summary>
   /// <exception cref="InvalidOperationException">Is thrown if executed in-memory.</exception>
   public static long NTile<TColumn1, TColumn2, TColumn3, TColumn4>(this DbFunctions _, int bucketCount, TColumn1 partitionByColumn1, TColumn2 partitionByColumn2, TColumn3 partitionByColumn3, TColumn4 partitionByColumn4, WindowFunctionOrderByClause orderBy)
   {
      throw new InvalidOperationException("This method is for use with Entity Framework Core only and has no in-memory implementation.");
   }
   ...
   /// </summary>
   /// <exception cref="InvalidOperationException">Is thrown if executed in-memory.</exception>
   public static long NTile<TColumn1, TColumn2, TColumn3, TColumn4, TColumn5>(this DbFunctions _, int bucketCount, TColumn1 partitionByColumn1, TColumn2 partitionByColumn2, TColumn3 partitionByColumn3, TColumn4 partitionByColumn4, TColumn5 partitionByColumn5, WindowFunctionOrderByClause orderBy)
   {
      throw new InvalidOperationException("This method is for use with Entity Framework Core only and has no in-memory implementation.");
   }
}
